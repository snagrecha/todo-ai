"""Tests for SQLiteTodoList storage strategy."""
...
@pytest.fixture
async def todo_list() -> SQLiteTodoList:
    """Create a fresh SQLiteTodoList with in-memory database for each test."""
    return SQLiteTodoList(db_path=":memory:")


class TestSQLiteTodoList:
    """Tests for SQLiteTodoList."""

    @pytest.mark.asyncio
    async def test_create_task(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_create_task_with_options(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_task(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_task_not_found(self, todo_list: SQLiteTodoList) -> None:
        """Test getting a non-existent task."""
        result = await todo_list.get_task("non-existent-id")
        assert result is None

    @pytest.mark.asyncio
    async def test_get_tasks_empty(self, todo_list: SQLiteTodoList) -> None:
        """Test getting tasks from empty list."""
        tasks = await todo_list.get_tasks()
        assert tasks == []

    @pytest.mark.asyncio
    async def test_get_tasks_all(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_tasks_by_agent_id(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_tasks_by_status(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_tasks_with_limit(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_tasks_sorted_by_priority(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_task(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_task_status(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_task_not_found(self, todo_list: SQLiteTodoList) -> None:
        """Test updating a non-existent task."""
        result = await todo_list.update_task("non-existent", content="Updated")
        assert result is None

    @pytest.mark.asyncio
    async def test_delete_task(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_task_not_found(self, todo_list: SQLiteTodoList) -> None:
        """Test deleting a non-existent task."""
        result = await todo_list.delete_task("non-existent")
        assert result is False

    @pytest.mark.asyncio
    async def test_get_next_task(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_next_task_empty(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_next_task_by_agent(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_mark_in_progress(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_mark_completed(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_mark_failed(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_mark_blocked(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_clear_all(self, todo_list: SQLiteTodoList) -> None:
    ...
    @pytest.mark.asyncio
    async def test_clear_by_agent(self, todo_list: SQLiteTodoList) -> None:
    ...
    async def test_persistence(self) -> None:
        """Test that data persists across instances with same db path."""
        import os
        import tempfile
        ...
        try:
            # Create a task with first instance
            todo_list1 = SQLiteTodoList(db_path=db_path)
            task = await todo_list1.create_task(content="Persistent task")

            # Create second instance and verify task exists
            todo_list2 = SQLiteTodoList(db_path=db_path)
            retrieved = await todo_list2.get_task(task.id)

            assert retrieved is not None
            assert retrieved.content == "Persistent task"
        finally:
            os.unlink(db_path)
